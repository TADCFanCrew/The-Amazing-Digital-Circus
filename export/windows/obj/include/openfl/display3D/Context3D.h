...
class HXCPP_CLASS_ATTRIBUTES Context3D_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		void _hx___clear(bool useScissor,::hx::Null< Float >  red,::hx::Null< Float >  green,::hx::Null< Float >  blue,::hx::Null< Float >  alpha,::hx::Null< Float >  depth,::hx::Null< int >  stencil,::hx::Null< int >  mask);

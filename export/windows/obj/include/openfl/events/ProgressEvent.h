...
#endif
HX_DECLARE_STACK_FRAME(_hx_pos_b09527e17bebd012_122_new)
...
HXLINE( 123)		__this->super::__construct(type,bubbles,cancelable);
HXLINE( 125)		( ( ::openfl::events::ProgressEvent)(__this) )->bytesLoaded = bytesLoaded;
HXLINE( 126)		( ( ::openfl::events::ProgressEvent)(__this) )->bytesTotal = bytesTotal;
            	}

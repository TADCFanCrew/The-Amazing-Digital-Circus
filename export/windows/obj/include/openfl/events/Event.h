...
HX_DECLARE_STACK_FRAME(_hx_pos_460ec5366bb20ab2_769_new)
...
HXLINE( 770)		( ( ::openfl::events::Event)(__this) )->type = type;
HXLINE( 771)		( ( ::openfl::events::Event)(__this) )->bubbles = bubbles;
HXLINE( 772)		( ( ::openfl::events::Event)(__this) )->cancelable = cancelable;
HXLINE( 773)		( ( ::openfl::events::Event)(__this) )->eventPhase = 2;
            	}

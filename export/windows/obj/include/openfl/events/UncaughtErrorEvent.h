...
#endif
HX_DECLARE_STACK_FRAME(_hx_pos_c2f85669dc13e38b_178_new)
...
HXLINE( 179)		__this->super::__construct(type,bubbles,cancelable,null(),null());
HXLINE( 181)		( ( ::openfl::events::UncaughtErrorEvent)(__this) )->error = error;
            	}

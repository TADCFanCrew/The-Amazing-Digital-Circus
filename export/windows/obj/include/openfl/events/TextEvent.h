...
#endif
HX_DECLARE_STACK_FRAME(_hx_pos_a9542994cee360f6_81_new)
...
HXLINE(  82)		__this->super::__construct(type,bubbles,cancelable);
HXLINE(  84)		( ( ::openfl::events::TextEvent)(__this) )->text = text;
            	}

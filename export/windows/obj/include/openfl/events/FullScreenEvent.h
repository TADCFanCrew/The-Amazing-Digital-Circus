...
#endif
HX_DECLARE_STACK_FRAME(_hx_pos_9acd580c71eb88b0_84_new)
...
HXLINE(  87)		__this->super::__construct(type,bubbles,cancelable,null());
HXLINE(  89)		( ( ::openfl::events::FullScreenEvent)(__this) )->fullScreen = fullScreen;
HXLINE(  90)		( ( ::openfl::events::FullScreenEvent)(__this) )->interactive = interactive;
            	}

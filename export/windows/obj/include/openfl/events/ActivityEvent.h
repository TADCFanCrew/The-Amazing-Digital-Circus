...
#endif
HX_DECLARE_STACK_FRAME(_hx_pos_07ba67a8dcdbfa28_62_new)
...
HXLINE(  63)		__this->super::__construct(type,bubbles,cancelable);
HXLINE(  65)		( ( ::openfl::events::ActivityEvent)(__this) )->activating = activating;
            	}

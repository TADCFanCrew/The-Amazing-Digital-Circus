...
#endif
HX_DECLARE_STACK_FRAME(_hx_pos_c70c2341539e31f3_174_new)
...
HXLINE( 175)		__this->super::__construct(type,bubbles,cancelable);
HXLINE( 177)		( ( ::openfl::events::KeyboardEvent)(__this) )->charCode = charCodeValue;
HXLINE( 178)		( ( ::openfl::events::KeyboardEvent)(__this) )->keyCode = keyCodeValue;
...
HXDLIN( 179)		( ( ::openfl::events::KeyboardEvent)(__this) )->keyLocation = _hx_tmp;
HXLINE( 180)		( ( ::openfl::events::KeyboardEvent)(__this) )->ctrlKey = ctrlKeyValue;
HXLINE( 181)		( ( ::openfl::events::KeyboardEvent)(__this) )->altKey = altKeyValue;
HXLINE( 182)		( ( ::openfl::events::KeyboardEvent)(__this) )->shiftKey = shiftKeyValue;
HXLINE( 185)		( ( ::openfl::events::KeyboardEvent)(__this) )->controlKey = controlKeyValue;
HXLINE( 186)		( ( ::openfl::events::KeyboardEvent)(__this) )->commandKey = commandKeyValue;
HXLINE( 189)		( ( ::openfl::events::KeyboardEvent)(__this) )->_hx___updateAfterEventFlag = false;
            	}

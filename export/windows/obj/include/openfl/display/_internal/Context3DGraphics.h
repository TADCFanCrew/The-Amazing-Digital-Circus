...
class HXCPP_CLASS_ATTRIBUTES Context3DGraphics_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::openfl::_Vector::FloatVector tempVerticesVector;
		static  ::openfl::_Vector::IntVector tempIndicesVector;
		static  ::openfl::_Vector::FloatVector tempUvtVector;
		static  ::openfl::_Vector::FloatVector tempScale9VerticesVector;
		...
		static void populateUvtVector( ::openfl::_Vector::FloatVector vertices, ::openfl::display::BitmapData bitmap, ::openfl::_Vector::FloatVector result);
		static ::Dynamic populateUvtVector_dyn();

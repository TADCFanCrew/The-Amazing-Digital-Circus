...
class HXCPP_CLASS_ATTRIBUTES CairoGraphics_obj : public ::hx::Object
{
	...
	public:
		...
		static  ::openfl::geom::Matrix bitmapFillMatrix;
		static  ::openfl::display::_internal::_CairoGraphics::Scale9GridBounds fillScale9Bounds;
		...
		static  ::openfl::geom::Matrix bitmapStrokeMatrix;
		static  ::openfl::display::_internal::_CairoGraphics::Scale9GridBounds strokeScale9Bounds;
		...
		static  ::Dynamic createImagePattern( ::openfl::display::BitmapData bitmapFill,bool bitmapRepeat,bool smooth);
		...
		static void drawRoundRect(Float x,Float y,Float width,Float height,Float ellipseWidth, ::Dynamic ellipseHeight, ::openfl::geom::Rectangle scale9Grid, ::Dynamic scale9UnscaledWidth, ::Dynamic scale9UnscaledHeight, ::Dynamic scaleX, ::Dynamic scaleY);
		...
		static Float toScale9Position(Float pos,Float scale9Start,Float scale9Center,Float unscaledSize,Float scale);
		static ::Dynamic toScale9Position_dyn();

		static void applyScale9GridUnscaledX(Float x);
		static ::Dynamic applyScale9GridUnscaledX_dyn();

		static void applyScale9GridUnscaledY(Float y);
		static ::Dynamic applyScale9GridUnscaledY_dyn();

		static void applyScale9GridScaledX(Float x);
		static ::Dynamic applyScale9GridScaledX_dyn();

		static void applyScale9GridScaledY(Float y);
		static ::Dynamic applyScale9GridScaledY_dyn();

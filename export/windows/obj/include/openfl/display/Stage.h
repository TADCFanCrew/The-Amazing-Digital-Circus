...
class HXCPP_CLASS_ATTRIBUTES Stage_obj : public  ::openfl::display::DisplayObjectContainer_obj
{
	...
	public:
		...
		Float _hx___mouseX;
		Float _hx___mouseY;
		Float _hx___untransformedMouseX;
		Float _hx___untransformedMouseY;
		...
		bool _hx___wasFullscreen;
		 ...
		 ::Dynamic _hx___oldStageOrientation;
		...
		void _hx___onLimeDisplayOrientationChange(int display,int orientation);
		::Dynamic _hx___onLimeDisplayOrientationChange_dyn();
		...
		void _hx___applyScaleAndAlign(Float windowWidth,Float windowHeight,Float scaleX,Float scaleY);
		::Dynamic _hx___applyScaleAndAlign_dyn();

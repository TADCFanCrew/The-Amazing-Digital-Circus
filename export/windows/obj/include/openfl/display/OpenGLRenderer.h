...
class HXCPP_CLASS_ATTRIBUTES OpenGLRenderer_obj : public  ::openfl::display::DisplayObjectRenderer_obj
{
	...
	public:
		...
		static  ::openfl::display::DisplayObjectShader _hx___staticDefaultDisplayShader;
		static  ::openfl::display::GraphicsShader _hx___staticDefaultGraphicsShader;
		static  ::openfl::display::_internal::Context3DMaskShader _hx___staticMaskShader;

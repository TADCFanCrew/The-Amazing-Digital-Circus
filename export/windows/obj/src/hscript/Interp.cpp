...
static const int _hx_array_data_9af07c8f_63[] = {
	(int)0,
};
...
HXDLIN( 389)				::Array< int > minParams = ::Array_obj< int >::fromData( _hx_array_data_9af07c8f_63,1);
HXLINE( 390)				{

...
HX_LOCAL_STACK_FRAME(_hx_pos_c98f1d3e0b4ce330_379___eq,"openfl.utils._Object.Object_Impl_","__eq",0x31759250,"openfl.utils._Object.Object_Impl_.__eq","openfl/utils/Object.hx",379,0xcbd6e8e2)
...
HXLINE( 133)		return ::Reflect_obj::getProperty(this1,key);
            	}
...
bool Object_Impl__obj::_hx___eq( ::Dynamic a, ::Dynamic b){
            	HX_STACKFRAME(&_hx_pos_c98f1d3e0b4ce330_379___eq)
HXLINE( 380)		 ::Dynamic dynamicA = a;
HXLINE( 381)		 ::Dynamic dynamicB = b;
HXLINE( 382)		return ::hx::IsEq( dynamicA,dynamicB );
            	}

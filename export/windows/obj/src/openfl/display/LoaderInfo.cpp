...
HX_DEFINE_STACK_FRAME(_hx_pos_bc206267402385e1_115_new,"openfl.display.LoaderInfo","new",0xaabc917d,"openfl.display.LoaderInfo.new","openfl/display/LoaderInfo.hx",115,0x88528a51)
HX_LOCAL_STACK_FRAME(_hx_pos_bc206267402385e1_425___complete,"openfl.display.LoaderInfo","__complete",0x9858c05c,"openfl.display.LoaderInfo.__complete","openfl/display/LoaderInfo.hx",425,0x88528a51)
HX_LOCAL_STACK_FRAME(_hx_pos_bc206267402385e1_440___update,"openfl.display.LoaderInfo","__update",0x44ca06ec,"openfl.display.LoaderInfo.__update","openfl/display/LoaderInfo.hx",440,0x88528a51)
HX_LOCAL_STACK_FRAME(_hx_pos_bc206267402385e1_406_create,"openfl.display.LoaderInfo","create",0xe80075ff,"openfl.display.LoaderInfo.create","openfl/display/LoaderInfo.hx",406,0x88528a51)
HX_LOCAL_STACK_FRAME(_hx_pos_bc206267402385e1_115_boot,"openfl.display.LoaderInfo","boot",0xb25bbc75,"openfl.display.LoaderInfo.boot","openfl/display/LoaderInfo.hx",115,0x88528a51)
HX_LOCAL_STACK_FRAME(_hx_pos_bc206267402385e1_117_boot,"openfl.display.LoaderInfo","boot",0xb25bbc75,"openfl.display.LoaderInfo.boot","openfl/display/LoaderInfo.hx",117,0x88528a51)
namespace openfl{
namespace display{

void LoaderInfo_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_bc206267402385e1_115_new)
HXLINE( 388)		this->width = -1;
HXLINE( 254)		this->height = -1;
HXLINE( 394)		super::__construct(null());
HXLINE( 396)		this->applicationDomain = ::openfl::_hx_system::ApplicationDomain_obj::currentDomain;
HXLINE( 397)		this->bytesLoaded = 0;
HXLINE( 398)		this->bytesTotal = 0;
HXLINE( 399)		this->childAllowsParent = true;
HXLINE( 400)		this->parameters =  ::Dynamic(::hx::Anon_obj::Create(0));
            	}
...
void LoaderInfo_obj::_hx___complete(){
            	HX_GC_STACKFRAME(&_hx_pos_bc206267402385e1_425___complete)
HXDLIN( 425)		if (!(this->_hx___completed)) {
HXLINE( 427)			if ((this->bytesLoaded < this->bytesTotal)) {
HXLINE( 429)				this->bytesLoaded = this->bytesTotal;
            			}
HXLINE( 432)			this->_hx___update(this->bytesLoaded,this->bytesTotal);
HXLINE( 433)			this->_hx___completed = true;
HXLINE( 435)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null()));
            		}
            	}
...
void LoaderInfo_obj::_hx___update(int bytesLoaded,int bytesTotal){
            	HX_GC_STACKFRAME(&_hx_pos_bc206267402385e1_440___update)
HXLINE( 441)		this->bytesLoaded = bytesLoaded;
HXLINE( 442)		this->bytesTotal = bytesTotal;
HXLINE( 444)		this->dispatchEvent( ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,HX_("progress",ad,f7,2a,86),false,false,bytesLoaded,bytesTotal));
            	}
...
::String LoaderInfo_obj::_hx___rootURL;
 ...
 ::openfl::display::LoaderInfo LoaderInfo_obj::create( ::openfl::display::Loader loader){
            	HX_GC_STACKFRAME(&_hx_pos_bc206267402385e1_406_create)
HXLINE( 407)		 ::openfl::display::LoaderInfo loaderInfo =  ::openfl::display::LoaderInfo_obj::__alloc( HX_CTX );
HXLINE( 408)		loaderInfo->uncaughtErrorEvents =  ::openfl::events::UncaughtErrorEvents_obj::__alloc( HX_CTX );
HXLINE( 410)		if (::hx::IsNotNull( loader )) {
HXLINE( 412)			loaderInfo->loader = loader;
            		}
            		else {
HXLINE( 416)			loaderInfo->url = ::openfl::display::LoaderInfo_obj::_hx___rootURL;
            		}
HXLINE( 419)		return loaderInfo;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_bc206267402385e1_115_boot)
HXDLIN( 115)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(2)
...
{
            	HX_STACKFRAME(&_hx_pos_bc206267402385e1_117_boot)
HXDLIN( 117)		_hx___rootURL = HX_("",00,00,00,00);
            	}
}

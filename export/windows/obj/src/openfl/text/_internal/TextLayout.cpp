...
HXLINE( 190)			::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::addString(this->_hx___hbBuffer,this->text,0,-1);
...
HXLINE( 214)				_hx_tmp4 = ::hx::IsNotNull( _positions );
            			}
            			else {
...
HXLINE( 231)								::Array< ::Dynamic> _hx_tmp5 = this->get_positions();
HXDLIN( 231)								 ::lime::math::Vector2 _hx_tmp6 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0);
HXDLIN( 231)								_hx_tmp5->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,0,_hx_tmp6, ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0)));
            							}
            						}
HXLINE( 234)						::Array< ::Dynamic> _hx_tmp7 = this->get_positions();
HXDLIN( 234)						int info1 = info->codepoint;
HXDLIN( 234)						 ::lime::math::Vector2 _hx_tmp8 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,((( (Float)(position->xAdvance) ) / ( (Float)(64) )) + this->letterSpacing),(( (Float)(position->yAdvance) ) / ( (Float)(64) )));
HXDLIN( 234)						_hx_tmp7->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,info1,_hx_tmp8, ::lime::math::Vector2_obj::__alloc( HX_CTX ,(( (Float)(position->xOffset) ) / ( (Float)(64) )),(( (Float)(position->yOffset) ) / ( (Float)(64) )))));

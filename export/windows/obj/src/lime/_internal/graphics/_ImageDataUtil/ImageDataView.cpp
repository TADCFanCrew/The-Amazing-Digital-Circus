...
void ImageDataView_obj::__construct( ::lime::graphics::Image image, ::lime::math::Rectangle rect){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1698_new)
HXLINE(1699)		this->image = image;
HXLINE(1701)		if (::hx::IsNull( rect )) {
HXLINE(1703)			this->rect = image->get_rect();
            		}
            		else {
...
HXLINE(1723)			this->tempRect =  ::lime::math::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            		}

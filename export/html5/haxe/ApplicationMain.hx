...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("TADCFangame", create);

		#if (js && html5)
		#if (munit || (utest && openfl_enable_utest_legacy_mode))
		lime.system.System.embed("TADCFangame", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "TADCFangame";
		app.meta["name"] = "The Amazing Digital Circus";
		app.meta["packageName"] = "com.tadc.fangame";
		...
		#elseif air
		app.window.title = "The Amazing Digital Circus";
		#else
